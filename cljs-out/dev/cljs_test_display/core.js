...
var node = cljs_test_display.core.n.call(null,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null),style_string_11068);
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq11069){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11070,G__11071,seq11069__$2);
}));
...
var vec__11075 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__11075,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__11075,(1),null);
var G__11078 = cljs.core.PersistentArrayMap.EMPTY;
var G__11078__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__11078,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__11078);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__11078__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__11078__$1;
}
} else {
...
return (function() { 
var G__11082__delegate = function (klass,contents){
var vec__11079 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__11079,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__11079,(1),null);
...
var G__11082 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__11083__i = 0, G__11083__a = new Array(arguments.length -  1);
while (G__11083__i < G__11083__a.length) {G__11083__a[G__11083__i] = arguments[G__11083__i + 1]; ++G__11083__i;}
  contents = new cljs.core.IndexedSeq(G__11083__a,0,null);
} 
return G__11082__delegate.call(this,klass,contents);};
G__11082.cljs$lang$maxFixedArity = 1;
G__11082.cljs$lang$applyTo = (function (arglist__11084){
var klass = cljs.core.first(arglist__11084);
var contents = cljs.core.rest(arglist__11084);
return G__11082__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__11088){
var map__11089 = p__11088;
var map__11089__$1 = cljs.core.__destructure_map.call(null,map__11089);
var ns = cljs.core.get.call(null,map__11089__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__11089__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__11090){
var map__11091 = p__11090;
var map__11091__$1 = cljs.core.__destructure_map.call(null,map__11091);
var actual = cljs.core.get.call(null,map__11091__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__11091__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__11092){
var map__11093 = p__11092;
var map__11093__$1 = cljs.core.__destructure_map.call(null,map__11093);
var expected = cljs.core.get.call(null,map__11093__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__11093__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__11094_SHARP_){
return cljs.core.cons.call(null,new_current_node,p1__11094_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__11096 = cljs_test_display.core.current_var_info.call(null);
var map__11096__$1 = cljs.core.__destructure_map.call(null,map__11096);
var info = map__11096__$1;
var name = cljs.core.get.call(null,map__11096__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__11096__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__11096__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__11095_SHARP_){
return cljs.core.cons.call(null,node,p1__11095_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__11097){
var map__11098 = p__11097;
var map__11098__$1 = cljs.core.__destructure_map.call(null,map__11098);
var m = map__11098__$1;
var fail = cljs.core.get.call(null,map__11098__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__11098__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__11098__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__11098__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5720__auto___11099 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11099)){
var message_11100 = temp__5720__auto___11099;
cljs.core.println.call(null,message_11100);
} else {
}
...
var temp__5720__auto___11101 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11101)){
var message_11102 = temp__5720__auto___11101;
cljs.core.println.call(null,message_11102);
} else {
}
