...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq12124){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12125,G__12126,seq12124__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__12130_SHARP_){
return (!((cljs.core.meta.call(null,p1__12130_SHARP_) == null)));
})))){
...
var map__12131 = opts;
var map__12131__$1 = cljs.core.__destructure_map.call(null,map__12131);
var markup_db = cljs.core.get.call(null,map__12131__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e12132){var _e__11351__auto__ = e12132;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e12134){var _e__11351__auto__ = e12134;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__12136 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__12137 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__12137);
...
var map__12138 = opts;
var map__12138__$1 = cljs.core.__destructure_map.call(null,map__12138);
var markup_db = cljs.core.get.call(null,map__12138__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__12136);
}});
...
var temp__5718__auto___12142 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___12142)){
var managed_print_level_12143 = temp__5718__auto___12142;
var _STAR_print_level_STAR__orig_val__12140_12144 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__12141_12145 = managed_print_level_12143;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__12141_12145);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__12139_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__12139_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__12140_12144);
}} else {
job_fn.call(null);
}
