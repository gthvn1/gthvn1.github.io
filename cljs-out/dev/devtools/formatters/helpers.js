...
var G__12088 = devtools.prefs.pref.call(null,v);
v = G__12088;
continue;
} else {
return v;
...
}catch (e12089){var _e__11351__auto__ = e12089;
return false;
}})();
...
}catch (e12091){var _e__11351__auto__ = e12091;
return false;
}})();
...
}catch (e12093){var _e__11351__auto__ = e12093;
return false;
}}
}
});
...
var vec__12095 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__12095,(0),null);
var name = cljs.core.nth.call(null,vec__12095,(1),null);
...
return cljs.core.some.call(null,(function (p1__12098_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__12098_SHARP_);
}),template);
});
