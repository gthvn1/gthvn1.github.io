...
var o11986 = temp__5718__auto__;
var temp__5718__auto____$1 = (o11986["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o11987 = temp__5718__auto____$1;
return (o11987["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__11344__auto__ = f;
return (o__11344__auto__["toString"]).call(o__11344__auto__);
} else {
return "";
}
}catch (e11988){var _ = e11988;
return "";
}});
...
try{var o__11344__auto___11990 = t;
(o__11344__auto___11990["cljs$lang$ctorPrWriter"]).call(o__11344__auto___11990,t,writer);
}catch (e11989){var __11991 = e11989;
}
...
var char_code = (function (){var o__11344__auto__ = (new String(char$));
return (o__11344__auto__["charCodeAt"]).call(o__11344__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__11344__auto__ = String;
return (o__11344__auto__["fromCharCode"]).call(o__11344__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__11992 = num_code;
switch (G__11992) {
case (1):
return (185);
...
var o__11344__auto__ = String;
return (o__11344__auto__["fromCharCode"]).call(o__11344__auto__,superscript_code);
});
/**
...
}catch (e11994){var _e__11351__auto__ = e11994;
return false;
}})())){
...
var vec__11995 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__11995,(0),null);
...
var len__4864__auto___12004 = arguments.length;
var i__4865__auto___12005 = (0);
while(true){
if((i__4865__auto___12005 < len__4864__auto___12004)){
args__4870__auto__.push((arguments[i__4865__auto___12005]));

var G__12006 = (i__4865__auto___12005 + (1));
i__4865__auto___12005 = G__12006;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12000){
var vec__12001 = p__12000;
var ns_detector = cljs.core.nth.call(null,vec__12001,(0),null);
...
var G__12007 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__12008 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__12007;
remaining_tokens = G__12008;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq11998){
var G__11999 = cljs.core.first.call(null,seq11998);
var seq11998__$1 = cljs.core.next.call(null,seq11998);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11999,seq11998__$1);
}));
...
var vec__12012 = cljs.core.split_with.call(null,(function (p1__12011_SHARP_){
return cljs.core.not_EQ_.call(null,p1__12011_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__12012,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__12012,(1),null);
...
var vec__12018 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__12018,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__12018,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__12021 = cljs.core.rest.call(null,remaining_tokens);
var G__12022 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__12021;
name_tokens = G__12022;
continue;
} else {
...
var vec__12025 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__12025,(0),null);
var arity = cljs.core.nth.call(null,vec__12025,(1),null);
var vec__12028 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__12028,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__12028,(1),null);
var vec__12031 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__12031,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__12031,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__12031,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__12031,(3),null);
...
var vec__12037 = result;
var munged_ns = cljs.core.nth.call(null,vec__12037,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__12037,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__12037,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__12037,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__12037,(4),null);
var arity = cljs.core.nth.call(null,vec__12037,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__12041 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__12041,(0),null);
var args = cljs.core.nth.call(null,vec__12041,(1),null);
var vec__12044 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__12044,(0),null);
var name = cljs.core.nth.call(null,vec__12044,(1),null);
...
var G__12047 = (arity + (1));
var G__12048 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12049){
var vec__12050 = p__12049;
var arity = cljs.core.nth.call(null,vec__12050,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__12050,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__12053_SHARP_){
return cljs.core.get.call(null,arities,p1__12053_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__12054_SHARP_){
return cljs.core.drop.call(null,(2),p1__12054_SHARP_);
}),sorted_infos);
...
var args__4870__auto__ = [];
var len__4864__auto___12061 = arguments.length;
var i__4865__auto___12062 = (0);
while(true){
if((i__4865__auto___12062 < len__4864__auto___12061)){
args__4870__auto__.push((arguments[i__4865__auto___12062]));

var G__12063 = (i__4865__auto___12062 + (1));
i__4865__auto___12062 = G__12063;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12057){
var vec__12058 = p__12057;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__12058,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12055){
var G__12056 = cljs.core.first.call(null,seq12055);
var seq12055__$1 = cljs.core.next.call(null,seq12055);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12056,seq12055__$1);
}));
...
var map__12066 = options;
var map__12066__$1 = cljs.core.__destructure_map.call(null,map__12066);
var include_ns_QMARK_ = cljs.core.get.call(null,map__12066__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__12066__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__12066__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__12066__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12067 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__12067,(0),null);
var fn_name = cljs.core.nth.call(null,vec__12067,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__12067,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__12067,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__12067,(4),null);
var arity = cljs.core.nth.call(null,vec__12067,(5),null);
...
var o__11344__auto__ = f;
return (o__11344__auto__["getBasis"]).call(o__11344__auto__);
});
/**
...
}catch (e12070){var _e__11351__auto__ = e12070;
...
var G__12071 = (obj[cljs.core.first.call(null,path)]);
var G__12072 = cljs.core.rest.call(null,path);
obj = G__12071;
path = G__12072;
continue;
} else {
...
var _STAR_ = (function (accum,p__12073){
var vec__12074 = p__12073;
var bit = cljs.core.nth.call(null,vec__12074,(0),null);
var protocol = cljs.core.nth.call(null,vec__12074,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12077){
var vec__12078 = p__12077;
var ns = cljs.core.nth.call(null,vec__12078,(0),null);
var name = cljs.core.nth.call(null,vec__12078,(1),null);
var selector = cljs.core.nth.call(null,vec__12078,(2),null);
...
var post_process = (function (p__12082){
var vec__12083 = p__12082;
var munged_name = cljs.core.nth.call(null,vec__12083,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__12083,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__12081_SHARP_){
return (obj[cljs.core.first.call(null,p1__12081_SHARP_)]);
}),sorted_matches);
