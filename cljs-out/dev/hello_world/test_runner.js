...
var len__4864__auto___11311 = arguments.length;
var i__4865__auto___11312 = (0);
while(true){
if((i__4865__auto___11312 < len__4864__auto___11311)){
args__4870__auto__.push((arguments[i__4865__auto___11312]));

var G__11313 = (i__4865__auto___11312 + (1));
i__4865__auto___11312 = G__11313;
continue;
} else {
}
break;
...
var reporter__5162__auto___11314 = new cljs.core.Keyword(null,"reporter","reporter",-805360621).cljs$core$IFn$_invoke$arity$1(cljs.test.empty_env.call(null));
if(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("cljs-test-display.core","default","cljs-test-display.core/default",-853427213),null,new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),null], null), null).call(null,reporter__5162__auto___11314))){
} else {
cljs.core._add_method.call(null,cljs.test.report,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reporter__5162__auto___11314,new cljs.core.Keyword(null,"end-run-tests","end-run-tests",267300563)], null),(function (m__5163__auto__){
return cljs.core.reset_BANG_.call(null,figwheel.main.testing.test_result_data,m__5163__auto__);
}));
}

cljs.test.run_block.call(null,(function (){var env11309 = cljs.test.empty_env.call(null);
...
cljs.test.set_env_BANG_.call(null,env11309);
...
return cljs.test.block.call(null,(function (){var env__10910__auto__ = cljs.test.get_current_env.call(null);
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){
if((env__10910__auto__ == null)){
...
return cljs.core._vreset_BANG_.call(null,summary11310,cljs.core.partial.call(null,cljs.core.merge_with,cljs.core._PLUS_).call(null,cljs.core._deref.call(null,summary11310),new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242).cljs$core$IFn$_invoke$arity$1(cljs.test.get_and_clear_env_BANG_.call(null))));
})], null)),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){
cljs.test.set_env_BANG_.call(null,env11309);

cljs.test.do_report.call(null,cljs.core.deref.call(null,summary11310));

cljs.test.report.call(null,cljs.core.assoc.call(null,cljs.core.deref.call(null,summary11310),new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"end-run-tests","end-run-tests",267300563)));
...
/** @this {Function} */
(hello_world.test_runner._main.cljs$lang$applyTo = (function (seq11308){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq11308));
}));
