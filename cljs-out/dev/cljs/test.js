...
var G__10978 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__10978,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__10978;
}
}));
...
var len__4864__auto___10983 = arguments.length;
var i__4865__auto___10984 = (0);
while(true){
if((i__4865__auto___10984 < len__4864__auto___10983)){
args__4870__auto__.push((arguments[i__4865__auto___10984]));

var G__10985 = (i__4865__auto___10984 + (1));
i__4865__auto___10984 = G__10985;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq10980){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10981,G__10982,seq10980__$2);
}));
...
var map__10987 = m;
var map__10987__$1 = cljs.core.__destructure_map.call(null,map__10987);
var file = cljs.core.get.call(null,map__10987__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__10987__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__10987__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__10986_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__10986_SHARP_));
...
var temp__5720__auto___10988 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___10988)){
var message_10989 = temp__5720__auto___10988;
cljs.core.println.call(null,message_10989);
} else {
}
...
var temp__5720__auto___10990 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___10990)){
var message_10991 = temp__5720__auto___10990;
cljs.core.println.call(null,message_10991);
} else {
}
...
var output_dir__$1 = (function (){var G__10992 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__10992,"/"].join('');
} else {
return G__10992;
}
})();
...
var G__10993 = exception.stack;
var G__10993__$1 = (((G__10993 == null))?null:clojure.string.split_lines.call(null,G__10993));
var G__10993__$2 = (((G__10993__$1 == null))?null:cljs.core.get.call(null,G__10993__$1,depth));
if((G__10993__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__10993__$2);
}
} else {
...
var vec__10994 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__10994,(0),null);
var column = cljs.core.nth.call(null,vec__10994,(1),null);
var vec__10997 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__10997,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__10997,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__10997,(2),null);
...
var m__$1 = (function (){var G__11000 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__11004 = (function (){var G__11003 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__11003);
} else {
return G__11003;
}
})();
...
return cljs.core.vary_meta.call(null,G__11005,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__11009 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__11009,(0),null);
var types = vec__11009;
...
return cljs.core.map.call(null,(function (p__11012){
var vec__11013 = p__11012;
var ns = cljs.core.nth.call(null,vec__11013,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__11013,(1),null);
return (function (){
...
var G__11016 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__11016__$1 = (((G__11016 instanceof cljs.core.Keyword))?G__11016.fqn:null);
switch (G__11016__$1) {
case "async":
...
var seq__11017 = cljs.core.seq.call(null,vars__$1);
var chunk__11018 = null;
var count__11019 = (0);
var i__11020 = (0);
while(true){
if((i__11020 < count__11019)){
var v = cljs.core._nth.call(null,chunk__11018,i__11020);
var temp__5720__auto___11022 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___11022)){
var t_11023 = temp__5720__auto___11022;
each_fixture_fn.call(null,((function (seq__11017,chunk__11018,count__11019,i__11020,t_11023,temp__5720__auto___11022,v,each_fixture_fn,G__11016,G__11016__$1,env,once_fixtures,each_fixtures,vec__11013,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11023)));
});})(seq__11017,chunk__11018,count__11019,i__11020,t_11023,temp__5720__auto___11022,v,each_fixture_fn,G__11016,G__11016__$1,env,once_fixtures,each_fixtures,vec__11013,ns,vars__$1))
);
} else {
}


var G__11024 = seq__11017;
var G__11025 = chunk__11018;
var G__11026 = count__11019;
var G__11027 = (i__11020 + (1));
seq__11017 = G__11024;
chunk__11018 = G__11025;
count__11019 = G__11026;
i__11020 = G__11027;
continue;
} else {
...
var G__11028 = cljs.core.chunk_rest.call(null,seq__11017__$1);
var G__11029 = c__4679__auto__;
var G__11030 = cljs.core.count.call(null,c__4679__auto__);
var G__11031 = (0);
seq__11017 = G__11028;
chunk__11018 = G__11029;
count__11019 = G__11030;
i__11020 = G__11031;
continue;
} else {
var v = cljs.core.first.call(null,seq__11017__$1);
var temp__5720__auto___11032__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___11032__$1)){
var t_11033 = temp__5720__auto___11032__$1;
each_fixture_fn.call(null,((function (seq__11017,chunk__11018,count__11019,i__11020,t_11033,temp__5720__auto___11032__$1,v,seq__11017__$1,temp__5720__auto__,each_fixture_fn,G__11016,G__11016__$1,env,once_fixtures,each_fixtures,vec__11013,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11033)));
});})(seq__11017,chunk__11018,count__11019,i__11020,t_11033,temp__5720__auto___11032__$1,v,seq__11017__$1,temp__5720__auto__,each_fixture_fn,G__11016,G__11016__$1,env,once_fixtures,each_fixtures,vec__11013,ns,vars__$1))
);
} else {
}


var G__11034 = cljs.core.next.call(null,seq__11017__$1);
var G__11035 = null;
var G__11036 = (0);
var G__11037 = (0);
seq__11017 = G__11034;
chunk__11018 = G__11035;
count__11019 = G__11036;
i__11020 = G__11037;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11016__$1)].join('')));
